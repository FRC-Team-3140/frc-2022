...
public class TurnToAngleVision extends CommandBase implements HardwareAdapter {
    ...
    public TurnToAngleVision(double throttle, double tolerance, double minSpeed) {
